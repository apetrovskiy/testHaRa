namespace interview.greedy.MinimumAbsoluteDifferenceInAnArray
{
	...
	public class MinimumAbsoluteDifferenceInAnArrayTest
	{
		...
		public void ShouldFindMinimumDifference(int[] inputArray, int expectedResult) => Assert.AreEqual(expectedResult, Solution.minimumAbsoluteDifference(inputArray));
	}
}
