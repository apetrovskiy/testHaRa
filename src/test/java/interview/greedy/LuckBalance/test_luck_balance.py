...
from src.main.java.interview.greedy.LuckBalance.luck_balance import luckBalance
...
@pytest.mark.parametrize("contests_number,contests,expected_result", test_data)
def test_luck_balance(
    contests_number: int, contests: List[List[int]], expected_result: int
):
